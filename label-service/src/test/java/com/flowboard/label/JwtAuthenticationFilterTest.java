...
import com.flowboard.label.security.JwtAuthenticationFilter;
...
class JwtAuthenticationFilterTest {
    ...
    @Test
    void labelsInternalPath_skipsAuth() throws Exception {
        MockHttpServletRequest r = req("/labels/internal/card/1");
    ...
    @Test
    void checklistsInternalPath_skipsAuth() throws Exception {
        MockHttpServletRequest r = req("/checklists/internal/card/1");
        MockHttpServletResponse res = new MockHttpServletResponse();
    ...
    void missingAuthHeader_returns401() throws Exception {
        MockHttpServletRequest r = req("/labels");
        MockHttpServletResponse res = new MockHttpServletResponse();
