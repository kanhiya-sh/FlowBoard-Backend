...
import com.flowboard.comment.security.JwtAuthenticationFilter;
...
class JwtAuthenticationFilterTest {
    ...
    void internalPath_skipsAuth() throws Exception {
        MockHttpServletRequest r = req("/comments/internal/card/1/count");
    ...
    void missingAuthHeader_returns401() throws Exception {
        MockHttpServletRequest r = req("/comments");
        MockHttpServletResponse res = new MockHttpServletResponse();
